...
- **Thunderbolt.** A two-second attack with a “Pika… CHUUU!” caption. Paced to the cry: while Pikachu charges, the screen darkens, an aura pulses and energy streaks spiral into it; on “CHUUU” it discharges a thick column of lightning straight up with channels fanning across the whole sky and to the screen edges, re-forking every few frames, with shockwave rings, a blinding wash, an electric web across the display, a crack and rumble and a hard shake; a second surge and a last crackle follow, then sparks rain down through the afterglow. It's a click-through overlay, so it never gets in the way of your work. The focus reminder plays the pose without the screen flash.
