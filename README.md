...
- **Thunderbolt.** A two-second attack with a “Pika… CHUUU!” caption. Real lightning, paced to the cry: the screen darkens a little and Pikachu's cheeks spark while it charges; a faint leader creeps up from its head, then on “CHUUU” the return stroke blazes, a thin white channel with a blue-violet glow and a few dim branches reaching the top of the screen, and re-strikes down the same channel three more times while the whole screen blinks; a smaller second flash lands on the tail of the cry, with a thunder crack and rumble and a slight shake. It's a click-through overlay, so it never gets in the way of your work. The focus reminder plays the pose without the screen flash.
